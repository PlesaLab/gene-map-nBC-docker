...
The intended use is to remove 504 primers from reference FASTA files

Usage:
    python scripts/trim_504_fasta.py input.fa output_trimmed.fa
    python scripts/trim_504_fasta.py input.fa output_trimmed.fa --trim5 25 --trim3 15

    
Example:
    python scripts/trim_504_fasta.py refs/Twist_384-1536_Unique/504_Primers/unique_overlap_lib384_gene_full_with_504.fasta refs/Twist_384-1536_Unique/unique_overlap_lib384_gene_full_wo_504.fasta
    python scripts/trim_504_fasta.py refs/Twist_384-1536_Unique/504_Primers/unique_overlap_lib1536_gene_full_with_504.fasta refs/Twist_384-1536_Unique/unique_overlap_lib1536_gene_full_wo_504.fasta

    python scripts/trim_504_fasta.py refs/AlignFdn/504_Primers/AF.lib2.384_wPad_wRE_wPrim.genes refs/AlignFdn/AF.lib2.384_wPad_wRE_n504.fasta
    python scripts/trim_504_fasta.py refs/AlignFdn/504_Primers/AF.lib16.1536_wPad_wRE_wPrim.genes refs/AlignFdn/AF.lib16.1536_wPad_wRE_n504.fasta
    python scripts/trim_504_fasta.py refs/AlignFdn/504_Primers/AF.lib18.1536_wPad_wRE_wPrim.genes refs/AlignFdn/AF.lib18.1536_wPad_wRE_n504.fasta
    python scripts/trim_504_fasta.py refs/AlignFdn/504_Primers/AF.lib20.1536_wPad_wRE_wPrim.genes refs/AlignFdn/AF.lib20.1536_wPad_wRE_n504.fasta
