...
ggsave(file="RMD/plots/DNGXRH_1_L71_raw_seq_length_histogram.png",
...
ggsave(file="RMD/plots/DNGXRH_1_L71_pct_perfect_histogram.png",
       dpi=600, width = 8, height = 6, units = "in")
```
...
# Save plot
ggsave(file="RMD/plots/DNGXRH_1_L71_rank_order_perfects.png",
       dpi=600, width = 8, height = 6, units = "in")
```
...
ggsave(file="RMD/plots/DNGXRH_1_L71_rank_order_all.png",
       dpi=600, width = 8, height = 6, units = "in")
```
