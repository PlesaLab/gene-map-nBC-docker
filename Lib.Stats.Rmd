...
# 384 Reference
target_genes1 = read.fasta("refs/lib384_gene_full_wo_504.fasta",
                           seqtype = "DNA", as.string = TRUE, set.attributes=FALSE)

# 1536 Reference
# target_genes1 = read.fasta("refs/lib1536_gene_full_wo_504.fasta",
#                            seqtype = "DNA", as.string = TRUE, set.attributes=FALSE)

# Birch Reference
# target_genes1 = read.fasta("refs/Birch_3_out_split_Lib1.full_nRE_nPrim.genes", seqtype = "DNA", as.string = TRUE, set.attributes=FALSE)
...
# 384 - 1x Beads
raw1 = read.fasta("out/R8FRST_1_384-1x.fasta", seqtype = "DNA", as.string = TRUE, set.attributes=FALSE)

# 384 - 2x Beads
# raw1 = read.fasta("out/R8FRST_2_384-2x.fasta", seqtype = "DNA", as.string = TRUE, set.attributes=FALSE)

# 1536
# raw1 = read.fasta("out/R8FRST_3_1536.fasta", seqtype = "DNA", as.string = TRUE, set.attributes=FALSE)

# # Birch (Latest Assembly)
# raw1 = read.fasta("out/R8FRST_4_L1-Slow.fasta", seqtype = "DNA", as.string = TRUE, set.attributes=FALSE)

# Birch (Original Assembly)
# raw1 = read.fasta("out/TDRTT3_1_sample_1.fasta", seqtype = "DNA", as.string = TRUE, set.attributes=FALSE)
...
ggsave(file="RMD/plots/R8FRST_1_384-1x_raw_seq_length_histogram.png",
...
# Birch (original assembly)
# SAM_listc1 <- read.sam("out/TDRTT3_1_sample_1.bbmap.merged.sam")
...
ggsave(file="RMD/plots/R8FRST_1_384-1x_pct_perfect_histogram.png",
       dpi=600, width = 8, height = 6, units = "in")
```
...
# Save plot
ggsave(file="RMD/plots/R8FRST_1_384-1x_rank_order_perfects.png",
       dpi=600, width = 8, height = 6, units = "in")
```
...
ggsave(file="RMD/plots/R8FRST_1_384-1x_rank_order_all.png",
       dpi=600, width = 8, height = 6, units = "in")
```
